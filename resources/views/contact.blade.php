    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-end mb-4">
                <div class="col-lg-6">
                    <h6 class="text-secondary font-weight-semi-bold text-uppercase mb-3">Biz bilan bog'lanish</h6>
                    <h1 class="section-title mb-3">Tozalash xizmatlari uchun biz bilan bog'laning</h1>
                </div>
